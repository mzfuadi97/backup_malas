...
<script src="asset/theme/jquery-3.1.1.min.js"></script>
 ...
 <section class="content-header">
  ...
  <li class="nav-item">
  <a class="nav-link active " href="./?p=ppak&aksi=adminunpost_ppak"><i class='fas fa-book'></i> Add New</a>
                </li>     
			  <li class="nav-item">
                <a class="nav-link" href="./?p=ppak&aksi=adminpost" ><i class='fas fa-envelope'></i> Manager</a>
              </li>
			  <li class="nav-item">
            ...
            <table id="example" class="table table-bordered table-striped" style = "width : 100%;">
              ...
              $sql1=mysqli_query($koneksi,"select * from ppak  o LEFT JOIN pegawai p ON o.kode_pegawai = p.kode_pegawai  where o.status=0");
              while($data=mysqli_fetch_array($sql1)){
               ...
               <td>$data[nama]</td>
                <td>
                  <!-- Edit Data Button -->
                  <a title='Edit Data' type='button' class='btn btn-xs btn-outline-primary' href='?p=ppak&aksi=edit&idppak=$data[id]'>
                  ...
                  <!-- Delete Data Button -->
                  <a title='Hapus Data' type='button' class='btn btn-xs btn-outline-danger btn-delete' data-id='$data[id]' href='?p=ppak&aksi=hapus&idppak=$data[id]'>
              ...
              <td>$data[nama]</td>
							...
							<td><a data-bs-toggle='tooltip' title='Edit Data' type='button' class='btn btn-xs btn-outline-primary' href='?p=ppak&aksi=edit&idppak=$data[id]'><i class='fas fa-edit'></i></a>  
							<a type='button' class='btn btn-xs btn-outline-success' href='?p=view&aksi=edit&idppak=$data[id]'><i class='fas fa-eye'></i></a> 
							<a type='button' class='btn btn-xs btn-outline-danger btn-delete' data-id='$data[id]' href='?p=view&aksi=hapus&idppak=$data[id]'><i class='fas fa-trash'></i></a></td>
