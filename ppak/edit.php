...
$idoff = $_GET['idoff'];
$sql=mysqli_query($koneksi,"SELECT * FROM off WHERE id='$_GET[idoff]'");
...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-keyboard"></i> Update Form Off Kerja</h1>
          </div>
          <div class="col-sm-6">
	...
	<div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
            <form role="form" action="module/kirim/kirim.php?kirim=edit&edit=adminunpost_off" method="post" id="form-off">
    <div class="card-body">
    <input type="hidden" name="id" id="idoff" value="<?= htmlspecialchars($idoff) ?>">
        <div class="row">
            <!-- Hari Kerja Libur Pertama -->
            <div class="col-sm-2">
                <div class="form-group">
                    <label class="control-label">Hari Kerja Libur</label>
                    <input value="<?=$data['hari_kerja']?>" type="date" class="form-control is-warning form-control-sm" name="hari_kerja" id="hari_kerja" required>
                </div>
            </div>
            ...
            <div class="col-sm-2">
                <div class="form-group">
                    ...
                    <input value="<?=$data['hari_off']?>" type="date" class="form-control is-warning form-control-sm" name="hari_off" id="hari_off" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <textarea class="form-control is-warning form-control-sm" name="keterangan" id="keterangan" rows="3" required><?=$data['keterangan']?></textarea>
                </div>
            </div>
        </div>
